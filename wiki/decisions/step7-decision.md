---
title: Step 7 Build Brief (Layer Switching + layer_links CRUD)
category: decision
created: 2026-04-29
updated: 2026-04-29
related: [[layer-linking-api]], [[alignment-model-studio]], [[project-status]]
---

Locked decisions for Step 7: writable layer switcher, layer_links CRUD, D3 layer crossfade animation, linked-objects nav panel, default traversal direction from originDirection, layer coverage badges, autosave active layer.
