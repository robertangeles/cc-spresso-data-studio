  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div
          ref={dropdownRef}
          className="absolute bottom-full left-0 mb-2 w-[300px] max-h-[340px] flex flex-col rounded-xl border border-border-subtle bg-surface-1 shadow-xl shadow-black/30 z-50 overflow-hidden"
        >
          {/* Search */}
