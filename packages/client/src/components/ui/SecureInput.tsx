    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className="w-full rounded-lg border border-border-default px-3 py-2 pr-10 text-sm text-text-primary placeholder:text-text-tertiary focus:border-accent/40 focus:outline-none focus:ring-1 focus:ring-accent/30 focus:ring-offset-2"
        />
        <button
          type="button"
