      ...
      <div className="relative z-10 w-full max-w-sm animate-slide-up">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-accent-dim border border-accent/20 shadow-glow-accent">
            <img src="/logo.svg" alt="Spresso" className="h-8 w-8" style={{ filter: 'brightness(0) saturate(100%) invert(83%) sepia(60%) saturate(1000%) hue-rotate(5deg) brightness(104%) contrast(104%)' }} />
          </div>
          ...
          <div className="relative rounded-2xl bg-surface-2/90 backdrop-blur-glass p-6 border border-border-subtle">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-text-tertiary">Min 8 characters, uppercase, lowercase, number</p>
              </div>
