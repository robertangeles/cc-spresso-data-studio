...
import { FolderKanban, Calendar, User2, Trash2, Building2 } from 'lucide-react';
...
export function ProjectsListPage() {
  ...
  const activeTab = (searchParams.get('tab') as ActiveTab) ?? 'projects';
  const [showCreate, setShowCreate] = useState(false);
  const [deleteId, setDeleteId] = useState<string | null>(null);
  // Used to externally trigger client create modal
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between mb-5 shrink-0">
        {/* Tab switcher */}
        <div className="flex items-center gap-1 bg-surface-3/40 rounded-xl p-1">
          <button
            type="button"
      ...
      {activeTab === 'projects' && (
        <div>
          ...
          >
            <p>
              Permanently delete this project and all its columns and cards? This cannot be undone.
            </p>
          </Modal>
        </div>
      )}
