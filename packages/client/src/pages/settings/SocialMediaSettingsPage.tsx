...
const PLATFORMS: PlatformInfo[] = [
  ...
  },
  {
    ...
    authType: 'oauth',
    credentialKeys: ['TWITTER_API_KEY', 'TWITTER_API_SECRET'],
    credentialLabels: ['API Key', 'API Secret'],
    setupSteps: [
      'Go to developer.x.com and create a project + app',
      'Subscribe to Basic tier ($100/mo) for write access',
      'Enable OAuth 2.0 with PKCE',
      'Enter API Key and API Secret below',
    ],
    status: 'coming-soon',
  },
  {
    ...
    icon: '💼',
    colorHex: '#3b82f6',
    description: 'Requires LinkedIn Developer app with Share on LinkedIn product',
    authType: 'oauth',
    credentialKeys: ['LINKEDIN_CLIENT_ID', 'LINKEDIN_CLIENT_SECRET'],
