...
const PLATFORMS: PlatformConfig[] = [
  {
    ...
    statusUrl: '/oauth/instagram/status',
    disconnectUrl: '/oauth/instagram/disconnect',
    charLimit: 2200,
    imageRequired: true,
  ...
  },
  {
    ...
    connectUrl: '/oauth/bluesky/connect',
    statusUrl: '/oauth/bluesky/status',
    disconnectUrl: '/oauth/bluesky/disconnect',
    charLimit: 300,
    imageRequired: false,
