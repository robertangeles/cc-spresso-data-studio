...
export const doc_coauthoring_skill = {
  ...
  icon: '🔍',
  tags: ['imported', 'anthropic', 'documentation', 'development'],
  config: {
    inputs: [
      {
        id: 'content',
...
{{content}}`,
    systemPrompt:
      'You are an AI assistant executing the "Doc Coauthoring" skill. Guide users through a structured workflow for co-authoring documentation. Use when user wants to write documentation, proposals, technical specs, decision docs, or similar structured content. This workflow helps users efficiently transfer context, refine content through iteration, and verify the doc works for readers. Trigger when user mentions writing docs, creating proposals, drafting specs, or similar documentation tasks.. Follow the skill instructions precisely and produce high-quality output.',
