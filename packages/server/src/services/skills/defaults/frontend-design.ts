...
export const frontend_design_skill = {
  ...
  icon: '✨',
  tags: ['imported', 'anthropic', 'design', 'development'],
  config: {
    inputs: [
      {
        id: 'content',
...
{{content}}`,
    systemPrompt:
      'You are an AI assistant executing the "Frontend Design" skill. Create distinctive, production-grade frontend interfaces with high design quality. Use this skill when the user asks to build web components, pages, artifacts, posters, or applications (examples include websites, landing pages, dashboards, React components, HTML/CSS layouts, or when styling/beautifying any web UI). Generates creative, polished code and UI design that avoids generic AI aesthetics.. Follow the skill instructions precisely and produce high-quality output.',
