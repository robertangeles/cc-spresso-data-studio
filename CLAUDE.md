...
- `wiki/entities/` — named things: Spresso Data Studio, Layer Linking API, Feature Flag System, Relationships feature, etc.
- `wiki/concepts/` — patterns and ideas: collaboration vision, RAG architecture, voice persona design, etc.
- `wiki/decisions/` — architectural decisions with date and rationale
- `wiki/synthesis/` — cross-cutting analysis, lessons, open questions, project status snapshots
